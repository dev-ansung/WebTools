...
<body class="bg-white min-h-screen flex flex-col items-center p-6 pt-16">
  <nav class="w-full max-w-page text-xs text-gray-400 mb-4">
    <a href="../index.html" class="text-gray-600 hover:text-gray-900">WebTools</a>
    <span class="mx-1">/</span>
    <span class="text-gray-900">My Tool</span>
  </nav>

  <div class="bg-white border border-gray-200 rounded-xl p-8 w-full max-w-page" x-data="{ ... }">
...
- **Base64 Encode / Decode** — convert text or files to/from Base64
- **Diff Viewer** — paste two text blocks and highlight line-by-line differences
- **Regex Tester** — write a regex, paste test text, highlight matches live
- **UUID Generator** — generate UUIDs (v4), copy one or bulk-export a list
